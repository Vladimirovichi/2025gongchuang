...
#define DI   PBin(0)     //Input pin //输入引脚

#define DO_H PBout(1)=1   //Command height //命令位高
#define DO_L PBout(1)=0   //Command low //命令位低

#define CS_H PAout(2)=1  //Cs pull up //CS拉高
#define CS_L PAout(2)=0  //Cs drawdown //CS拉低

#define CLK_H PAout(3)=1 //Clock lift //时钟拉高
#define CLK_L PAout(3)=0 //Clock down //时钟拉低
